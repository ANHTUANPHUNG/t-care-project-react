          ...
          <tr key={e.id}>
            ...
            <td style={{ width: "250px" }}>
              {mergedData.map((mergedItem, index) => (
                <div key={index}>
                  {mergedItem.dateInWeekName} - {mergedItem.sessionOfDate.join(", ")}
                </div>
              ))}
            </td>
            <td>
            ...
            <td style={{ width: "170px" }}>{e.infoList.map((e) => e.name).join(", ")}</td>
            <td style={{ width: "170px" }}>{e.skillList.map((e) => e.name).join(", ")}</td>
            <td>{e.cartStatus}</td>
            <td>
              <i
                data-id={e.id}
